...
class PickMethod {
      ...
      method: (BuildContext context, List<AssetEntity> assets) {
        return AssetPicker.pickAssets(
          ...
          selectedAssets: assets,
           // RequestType.common 请求图片和视频资源
          requestType: RequestType.common,
          // specialItemPosition.prepend：  在列表前放入一个widget
          specialItemPosition: SpecialItemPosition.prepend,
          // builderItem
          // 第一个表格为拍照相机widget
          specialItemBuilder: (BuildContext context) {
    ...
    return PickMethod(
      ...
      method: (BuildContext context, List<AssetEntity> assets) {
        return AssetPicker.pickAssets(
          ...
          maxAssets: maxAssetsCount,
          selectedAssets: assets,
          themeColor:const Color(0xff56bfeb),
  ...
  ///自定义相册最前面的widget 一个特殊项目将前置到资产网格中。
    ...
    return PickMethod(
      ...
      method: (BuildContext context, List<AssetEntity> assets) {
        return AssetPicker.pickAssets(
          ...
          selectedAssets: assets,
          requestType: RequestType.common,
          // SpecialItemPosition.prepend：Add as leading of the list. 在列表前放入
          specialItemPosition: SpecialItemPosition.prepend,
          specialItemBuilder: (BuildContext context) {
            return const Center(
